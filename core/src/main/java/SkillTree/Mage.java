    ...
    public static Char build(float headerX, float screenH, float scale) {
        ...
        Skill[] skills = {
            ...
            new Skill("infernal_explosion", "Пекельний Вибух",
                "Викликає масштабний вогняний вибух по широкій площі, завдаючи важкої шкоди.",
            ...
            new Skill("frosty_breath", "Крижаний Подих",
                "Випускає заморожуючий потік що паралізує ворогів на 5 секунд.",
                new Texture("skillTree/FrostyBreath.png"),
                iceX, startY - step, "freezing"),

            new Skill("ice_storm", "Крижана Буря",
                "Викликає хуртовину що заморожує всіх ворогів у заданому радіусі навколо героя.",
                new Texture("skillTree/IceStorm.png"),
                iceX, startY - step * 2, "frosty_breath"),

            // WATER
            new Skill("wave", "Хвиля",
                "Випускає хвилю води що відштовхує ворогів на задану відстань.",
                new Texture("skillTree/Wave.png"),
                waterX, startY, null),

            new Skill("whirlpool", "Вир",
                "Створює вихор що притягує всіх сусідніх ворогів до центру та завдає постійної шкоди.",
                new Texture("skillTree/Whirlpool.png"),
                waterX, startY - step, "wave"),

            new Skill("tsunami", "Цунамі",
                "Вивільняє масивну хвилю в усіх напрямках навколо героя, відкидаючи ворогів та завдаючи важкої шкоди.",
            ...
            new Skill("earthquake", "Землетрус",
                "Б'є по землі викликаючи ударну хвилю що приголомшує всіх ворогів у широкій зоні навколо героя.",
                new Texture("skillTree/Earthquake.png"),
                earthX, startY - step, "stone"),

            new Skill("stone_wall", "Кам'яна Стіна",
                "Піднімає кам'яну стіну що блокує рух ворогів та відштовхує їх назад.",
